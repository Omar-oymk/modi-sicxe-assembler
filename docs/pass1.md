...
- **`core/parser.py`**: Reads the source file, strips comments, tokenizes instructions, and classifies them into `Line` data structures.
- **`core/pass1.py`**: The orchestrator for Pass 1, managing table construction.
